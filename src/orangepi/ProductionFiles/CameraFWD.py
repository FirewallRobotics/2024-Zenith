#!/usr/bin/env python3
# Sample code from wpilib.local server on pi image
...
if __name__ == "__main__":
    ...
    #server2 = CameraServer.addSwitchedCamera(config.name)
    #cvSink = server2.getVideo()
    output = server.putVideo("AprilTags", 680, 360)
