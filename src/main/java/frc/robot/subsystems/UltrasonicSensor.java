...
//   //public AnalogInput ultrasonicSensor = new
// AnalogInput(UltrasonicConstants.kUltrasonicSensorPort);

//   // Ultrasonic range. How far an object was from the sensor. The closer the object, the higher
// the
//   // mm.
...
//   // double currentDistanceCentimeters = ultrasonicSensor.getValue() * voltage_scale_factor *
// 0.125;
