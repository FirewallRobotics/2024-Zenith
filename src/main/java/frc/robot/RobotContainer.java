...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    if(bonusTrajectory != null){
        bonusSwerveControllerCommand = new SwerveControllerCommand(
        myTrajectory,
        m_robotDrive::getPose, // Functional interface to feed supplier
        DriveConstants.kDriveKinematics,
    ...
    if(bonusSwerveControllerCommand == null){
        ...
        return swerveControllerCommand.andThen(bonusSwerveControllerCommand).andThen(() -> m_robotDrive.drive(0, 0, 0, false, false));
    }
  }
  ...
  private Trajectory getForward180Trajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory forward180Trajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // No additional interior waypoints
        List.of(),
  ...
  private Trajectory getDiagonalTrajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory diagonalTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // No additional interior waypoints
        List.of(),
  ...
  private Trajectory getDiagonal90Trajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory diagonal180Trajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // No additional interior waypoints
        List.of(),
  ...
  private Trajectory getCurveTrajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory curveTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
  ...
  private Trajectory getCurve180Trajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory curve180Trajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // Pass through this interior waypoint, making "halfpipe" curve path
        List.of(new Translation2d(0.2, -0.8)),
  ...
  private Trajectory getBigCurve180Trajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory bigCurve180Trajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // Pass through this interior waypoint, making an 'c' curve path to the left? of the start
  ...
  private Trajectory getRightTrajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory downTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // No additional interior waypoints
        List.of(),
  ...
  private Trajectory getSpinTrajectory(TrajectoryConfig config){
    // An example trajectory to follow. All units in meters.
    Trajectory spinTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0, 0, new Rotation2d(0)),
        // No additional interior waypoints
        List.of(),
